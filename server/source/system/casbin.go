...
func (i *initCasbin) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []adapter.CasbinRule{
		...
		{Ptype: "p", V0: "888", V1: "/dataSource/createDataSource", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/dataSource/updateDataSource", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/dataSource/deleteDataSource", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/dataSource/getDataSourceList", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/dataSource/getDataSourceById", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/dataSource/testConnection", V2: "POST"},
		...
		{Ptype: "p", V0: "8881", V1: "/dataSource/createDataSource", V2: "POST"},
		{Ptype: "p", V0: "8881", V1: "/dataSource/updateDataSource", V2: "POST"},
		{Ptype: "p", V0: "8881", V1: "/dataSource/deleteDataSource", V2: "POST"},
		{Ptype: "p", V0: "8881", V1: "/dataSource/getDataSourceList", V2: "POST"},
		{Ptype: "p", V0: "8881", V1: "/dataSource/getDataSourceById", V2: "POST"},
		{Ptype: "p", V0: "8881", V1: "/dataSource/testConnection", V2: "POST"},
		...
		{Ptype: "p", V0: "9528", V1: "/dataSource/createDataSource", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/dataSource/updateDataSource", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/dataSource/deleteDataSource", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/dataSource/getDataSourceList", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/dataSource/getDataSourceById", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/dataSource/testConnection", V2: "POST"},
